                    ...
                    <div class="container-fluid">
                        ...
                        <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav navbar-right">
                                <li><p class="navbar-text"> <?php echo "Olá, <b> $usuario </b>"; ?></p></li>
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            if ($row["status"] == 0) {
                ...
                echo "      <div id=\"" . $row["idchave"] . "\"  class=\"chaves col-sm-1 col-xs-3\">  
                                <button value=\"0\" name=\"" . $row["idchave"] . "\"  onclick=\"loc(" . $row["idchave"] . ",'" . $e . "',0," . $row["status"] . ")\" class=\"btn btn-success\" type=\"button\"  data-toggle=\"tooltip\" title=\"" . $row['descricao'] . "\" data-placement=\"top\"  >
...
// conectar com o bando de dados.
    $con = conexao();
// A variavel $result pega as varias $login e $senha, faz uma pesquisa na tabela de usuarios
    $sql = "SELECT * FROM locacao ORDER BY horaPeg ASC ";
